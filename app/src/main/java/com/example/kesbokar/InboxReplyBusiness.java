...
//                startActivity(mail);
    ...
    {
        String url1="http://serv.kesbokar.com.au/jil.0.1/v1/quotes-yellowpage/"+bundle.getInt("id") +"reply"+id+"&api_token=FSMNrrMCrXp2zbym9cun7phBi3n2gs924aYCMDEkFoz17XovFHhIcZZfCCdK";
